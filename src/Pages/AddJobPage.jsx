...
const AddJobPage = ({ addJobSubmit }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await addJobSubmit(jobData); // ✅ Wait for job submission
            
            if (response) {
                toast.success("Job added successfully!", {autoClose:1000});
                console.log('Navigating to /jobs...');
               return navigate('/jobs');  // ✅ Ensure navigation happens only after successful API response
            } else {
        ...
        <section className="bg-indigo-50">
            <div className="container m-auto max-w-2xl py-24">
                <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                    <form onSubmit={handleSubmit}>  {/* ✅ Uses handleSubmit */}
